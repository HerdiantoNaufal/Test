...
public class TimedInputObject2 : MonoBehaviour, TimedInputHandler
{
    public Text data;
    ...
    void Start()
    {
        ...
        //GameObject.Find("slippers").GetComponent<GameObject>();
        //GameObject names = GameObject.Find("slippers");
    }
